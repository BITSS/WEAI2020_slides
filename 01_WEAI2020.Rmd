...
date:  "`r format(as.Date('2020-06-27'), '%d %B %Y')` | [slides](https://github.com/BITSS/ACRE/tree/master/slides) <br> .font80[(note: use the left and right arrow keys to navigate through slides)]"
output: 
